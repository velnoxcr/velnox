          ...
          <div className="lg:col-span-8">
            ...
            <Reveal delay={0.05}>
              <h2 className="font-display text-display-lg font-semibold tracking-tightest text-ink-700 text-balance">
                A clear path from <span className="ocean-text-gradient">feasibility</span> to <span className="ocean-text-gradient">archival</span>.
              </h2>
            </Reveal>
          </div>
          <div className="lg:col-span-4">
            <Reveal delay={0.1} direction="left">
              <p className="text-[14.5px] text-ink-400">
                Six clearly-defined steps in every Velnox engagement — with named ownership and sponsor visibility
                at each stage.
              </p>
            </Reveal>
          </div>
